...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/05/19 11:48:43 by ppepperm          #+#    #+#             */
/*   Updated: 2020/05/19 11:48:45 by ppepperm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			init_doors(t_data *data, t_i2 count)
{
	...
	if (!(door_new = (t_door*)malloc(sizeof(t_door))))
		return (0);
	door_new->pos = count;
	door_new->len = 1;
