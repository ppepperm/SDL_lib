...
int	check_value(t_data *data, t_i2 count)
{
	if (data->map[count.y][count.x] < 0 || data->map[count.y][count.x] > 10)
	{
...
int	check_border(t_data *data, t_i2 count)
{
...
int	check_player(t_data *data, t_i2 count)
{
