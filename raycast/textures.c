...
void		init_textures_dark(t_data *data, SDL_Renderer *renderer)
{
	...
	load_image("textures_dark/bluestone.bmp", 0, data->textures_dark, renderer);
	load_image("textures_dark/colorstone.bmp", 1,
		data->textures_dark, renderer);
	load_image("textures_dark/eagle.bmp", 2, data->textures_dark, renderer);
	load_image("textures_dark/greystone.bmp", 3, data->textures_dark, renderer);
	load_image("textures_dark/mossy.bmp", 4, data->textures_dark, renderer);
	load_image("textures_dark/purplestone.bmp", 5,
		data->textures_dark, renderer);
	load_image("textures_dark/redbrick.bmp", 6, data->textures_dark, renderer);
	load_image("textures_dark/wood.bmp", 7, data->textures_dark, renderer);
	load_image("textures_dark/door1.1.bmp", 8, data->textures_dark, renderer);
	load_image("textures_dark/door1.2.bmp", 9, data->textures_dark, renderer);
}
...
void		init_skybox(t_data *data, SDL_Renderer *renderer)
{
	...
	surface = SDL_LoadBMP("textures/skybox1440.bmp");
